...
public class QCartItem extends EntityPathBase<CartItem> {
    ...
    private static final long serialVersionUID = -1551170202L;
    ...
    public final com.jzargo.common.QCartItemId id;
    ...
    public QCartItem(Class<? extends CartItem> type, PathMetadata metadata, PathInits inits) {
        ...
        this.id = inits.isInitialized("id") ? new com.jzargo.common.QCartItemId(forProperty("id")) : null;
